...
This mechanism has been integrated into Bitcore-Node-HrGold which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hrgoldpay/insight-api-hrgold#web-socket-api](https://github.com/hrgoldpay/insight-api-hrgold#web-socket-api)
* API: [https://github.com/hrgoldpay/insight-api-hrgold#instantsend-transactions](https://github.com/hrgoldpay/insight-api-hrgold#instantsend-transactions)
...
By default, the HrGold Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the HrGold Core daemon:
