...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print HrGold address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "hrgold",               "masternode",             &masternode,             true,  {} },
    { "hrgold",               "masternodelist",         &masternodelist,         true,  {} },
    { "hrgold",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "hrgold",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "hrgold",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "hrgold",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
