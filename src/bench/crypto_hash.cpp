...
// Copyright (c) 2018 The HrGold Core developers
...
static void HASH_LYRA2V2(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(BUFFER_SIZE,0);
    while (state.KeepRunning())
        hash = lyra2re2_hash(in.begin(), in.end());
}

static void HASH_LYRA2V2_0032b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(32,0);
    while (state.KeepRunning())
...
static void HASH_LYRA2V2_0080b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(80,0);
    while (state.KeepRunning())
...
static void HASH_LYRA2V2_0128b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(128,0);
    while (state.KeepRunning())
...
static void HASH_LYRA2V2_0512b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(512,0);
    while (state.KeepRunning())
...
static void HASH_LYRA2V2_1024b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(1024,0);
    while (state.KeepRunning())
...
static void HASH_LYRA2V2_2048b_single(benchmark::State& state)
{
    uint256 hash;
    std::vector<uint8_t> in(2048,0);
    while (state.KeepRunning())
...
BENCHMARK(HASH_LYRA2V2_0032b_single);
BENCHMARK(HASH_LYRA2V2_0080b_single);
BENCHMARK(HASH_LYRA2V2_0128b_single);
BENCHMARK(HASH_LYRA2V2_0512b_single);
BENCHMARK(HASH_LYRA2V2_1024b_single);
BENCHMARK(HASH_LYRA2V2_2048b_single);
