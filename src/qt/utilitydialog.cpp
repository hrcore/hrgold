    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  hrgold-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        std::string strUsage = HelpMessage(HMM_HRGOLD_QT);
...
All the HrGold in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 HRG, 0.1 HRG, 1 HRG and 10 HRG -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://hrgoldpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://hrgoldpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
