...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all HrGold related functionality
...
/*
    ...
    allow endless transaction that would bloat HrGold and make it unusable. To
