...
2. run hrgoldd with -printalert or -sendalert like this:
   /path/to/hrgoldd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.hrgold.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/HrGold Core:0.12.0.58/"));
