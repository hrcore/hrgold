...
official/supported Docker Images found at https://hub.docker.com/r/hrgoldpay/hrgoldd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/hrgoldpay/hrgoldd-develop/ when changing the above text**