# Linearize
Construct a linear, no-fork, best version of the HrGold blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install hrgold_hash

https://github.com/hrgoldpay/hrgold_hash
...
JSON-RPC server. Running `hrgoldd` or `hrgold-qt -server` will be sufficient.
...
* `input`: hrgoldd blocks/ directory containing blkNNNNN.dat
